...
def glafic_tabular(filename_0, filename_6, save_table_flag = False, shear = False, show_shear = False, show_params = False):
    ...
    line_set_1 = find_line('lens', content)
    line_opt_1 = find_line('start_setopt', content)

    if shear == True:
        line_set_2 = find_line('pert,', content)
        line_opt_2 = find_line('start_setopt', content)
    ...
    setopt_lens_1 = content_list[line_opt_1]
    ...
    # Get the shear set_lens line
        ...
        setopt_lens_2 = content_list[line_opt_2]
    ...
    for i in models:
        ...
        if i in set_lens_1:
            if i == models[1].lower(): # POW model
                name = models[1]
                z_s = parts_set_lens[4]
                x = parts_set_lens[5]
                y = parts_set_lens[6]
                e = parts_set_lens[7]
                pa = parts_set_lens[8]
                r_ein = parts_set_lens[9]
                pwi = parts_set_lens[9].replace(')', '') 

                z_s_flag = parts_setopt_lens[1]
                x_flag = parts_setopt_lens[2]
                y_flag = parts_setopt_lens[3]
                e_flag = parts_setopt_lens[4]
                pa_flag = parts_setopt_lens[5]
                r_ein_flag = parts_setopt_lens[6]
                pwi_flag = parts_setopt_lens[7].replace(')', '') 
                ...
                name = models[0]
                sigma = parts_set_lens[4]
                x = parts_set_lens[5]
                y = parts_set_lens[6]
                e = parts_set_lens[7]
                pa = parts_set_lens[8]
                r_core = parts_set_lens[9]
                pwi = parts_set_lens[9].replace(')', '') 

                sigma_flag = parts_setopt_lens[1]
                x_flag = parts_setopt_lens[2]
                y_flag = parts_setopt_lens[3]
                e_flag = parts_setopt_lens[4]
                pa_flag = parts_setopt_lens[5]
                r_core_flag = parts_setopt_lens[6]
                pwi_flag = parts_setopt_lens[7].replace(')', '') 
                ...
                m_flag = parts_setopt_lens[1]
                x_flag = parts_setopt_lens[2]
                y_flag = parts_setopt_lens[3]
                e_flag = parts_setopt_lens[4]
                pa_flag = parts_setopt_lens[5]
                c_flag = parts_setopt_lens[6]
                Nan_flag = parts_setopt_lens[7].replace(')', '')
